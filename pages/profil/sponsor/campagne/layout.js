...
const CampagneHeader = ({image}) => {
    return (
        <header className='tw-flex tw-justify-center tw-h-52 tw-bg-gradient-to-br tw-from-gray-800 tw-to-black/90
            ...
            <Image className="tw-shadow-md" radius={'lg'} width={220} height={120} src={`/uploads/${image}`} alt="With default placeholder" withPlaceholder/>
            </div>
        </header>
    )
}
